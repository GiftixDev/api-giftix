...
module.exports = {
    ...
    auth: {
        discord: {
            ...
            secret: "",
            callback: "https://giftix-api.netlify.appv/1/auth/callback",
        ...
        youtube: {
            id: "",
            secret: "",
            callback: "https://award-bot-api.herokuapp.com/v1/connections/youtube/callback",
        ...
        github: {
            id: "",
            secret: "",
            callback: "https://award-bot-api.herokuapp.com/v1/connections/github/callback",
            scopes: [ "read:user" ]
        },
        twitter: {
            id: "",
            secret: "",
            callback: "https://award-bot-api.herokuapp.com/v1/connections/twitter/callback",
        ...
        tiktok: {
            key: "",
            secret: "",
            callback: "https://award-bot-api.herokuapp.com/v1/connections/tiktok/callback",
            scopes: [ "user.info.basic"  ]
        },
        telegram: {
          id: "",
          secret: "",
          callback: "https://award-bot-api.herokuapp.com/v1/connections/telegram/callback"
        }
    },
    requireds: {
        youtube: {
    ...
    mongoURL: "mongodb+srv://giftix-user:Google76!@cluster0.bxq0r.mongodb.net/myFirstDatabase?retryWrites=true&w=majority",
    token: "OTUyNTUxNzUzMzg2MTY0MjU1.GyWOpt.7tzJRCiKlE_M73QAK_FBIPOefMelyAxNlaISb4",
    cmdDir: "./src/commands",
    benefits: _lvl => ([
        {
            category: "feature",
